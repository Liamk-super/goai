  ...
  return <html lang="en"><body>
    <div className="app-frame">
      <div className="demo-banner">
        <span>Recorded acceptance snapshot · Read only · not live AgentTeams execution</span>
        <a href="/demo-login">Enter live Demo</a>
      </div>
      {children}
      <footer className="app-footer">
        <span>Evidence before assertion.</span>
        <span>No writes are available on this route.</span>
      </footer>
    </div>
  </body></html>;
}
